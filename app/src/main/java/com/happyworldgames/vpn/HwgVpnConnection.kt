...
class HwgVpnConnection(
    service: VpnService, connectionId: Int,
    serverName: String?, serverPort: Int, sharedSecret: ByteArray,
    proxyHostName: String?, proxyHostPort: Int, allow: Boolean,
    packages: Set<String>?
) : Runnable {

    companion object {
        /** Maximum packet size is constrained by the MTU, which is given as a signed short.  */
        private val MAX_PACKET_SIZE: Int = Short.MAX_VALUE.toInt()
         ...
         */
        private const val MAX_HANDSHAKE_ATTEMPTS: Int = 50
    }
    ...
    private val mConnectionId = connectionId

    private var mServerName: String? = serverName
    private var mServerPort = serverPort
    private var mSharedSecret: ByteArray = sharedSecret
    ...
    private var mPackages: Set<String>? = packages
    ...
    private fun getTag(): String {
        return HwgVpnConnection::class.java.simpleName + "[" + mConnectionId + "]"
    }
}